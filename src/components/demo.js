...
if($('.ct-chart-sale').length) {
  new Chartist.Line('.ct-chart-sale', {
    ...
    series: [
      [2710 ,2810 ,4210 ,8010 ,19158 ,35326 ,80837 ,79477 ,88561 ,67807 ,70837 ,55261 ,66216 ,10516 ,13493 ,12000 ,14253 ,33506 ,56326 ,78986 ,20747 ,44165 ,13817 ,2200 ,65488 ,30704 ,24000 ,16294 ,18847 ,4269],
    ]
  }, {
    axisX: {
      position: 'center'
